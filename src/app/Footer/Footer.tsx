...
export default function Footer() {
  const { setCurrentSection, setHeaderHeight, setBgIsBlackFooter } = useSection();
  const { data } = useData();
  ...
  const { title, subtitle, phoneNumber, fixNumber, address } = data[langCode].footer;
  ...
  return (
    <div
      ...
      onMouseEnter={() => {setBgIsBlackFooter(true); console.log('in the footer')}}
      onMouseLeave={() => {setBgIsBlackFooter(false); console.log('left the footer')}}
    >
      <div
        id="footer-title"
      ...
      >
        <div className="border border-y-[0.5px] border-x-0 sm:gap-0 border-white/20 h-[90%] w-4/5 flex justify-around items-center pb-2 sm:pb-0 sm:items-start pt-0 sm:pt-3">
          <div
            id="footer-contact"
          ...
          >
            <a
              ...
              target="_blank"
              className="uppercase hover:scale-105 text-center transition duration-150 text-xs md:text-base"
            >
              {address}
            </a>
            <a
            ...
            <a
              ...
              className="uppercase hover:scale-105 transition duration-150 text-xs md:text-base hidden md:block"
            >
              {fixNumber}
            </a>
          </div>
          ...
          >
            <div className="flex justify-center items-center gap-2 md:gap-10">
              ...
              <a
                ...
                className="hover:scale-125 transition duration-150 hover:brightness-150"
              >
                <img data-clickable={true} src="data:image/svg+xml;charset=utf8,%3Csvg width='20' height='16' viewBox='0 0 20 16' version='1.1' xmlns='http://www.w3.org/2000/svg' xmlns:xlink='http://www.w3.org/1999/xlink'%3E%3Cdefs%3E%3Cpath d='M9.52217 6.77143L15.4785 0H14.0671L8.89516 5.87954L4.76437 0H0L6.24656 8.8909L0 15.9918H1.41155L6.87321 9.78279L11.2356 15.9918H16L9.52183 6.77143H9.52217ZM7.58887 8.96923L6.95596 8.0839L1.92015 1.03921H4.0882L8.15216 6.7245L8.78507 7.60983L14.0677 14.9998H11.8997L7.58887 8.96957V8.96923Z' id='a'/%3E%3C/defs%3E%3Cg stroke='none' stroke-width='1' fill='none' fill-rule='evenodd'%3E%3Cg%3E%3Cmask fill='white'%3E%3Cuse xlink:href='%23a'/%3E%3C/mask%3E%3Cuse fill='dimgray' xlink:href='%23a'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E" alt="" />
              </a>
            </div>
          </div>
        </div>
