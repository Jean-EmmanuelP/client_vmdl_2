...
export default function Paragraph({ children, homeSection }: ParagraphProps) {
  ...
  return (
    <>
      ...
      <div
        ref={paragraphRef}
        className={`w-[70%] transition duration-500 h-fit flex flex-col ${homeSection ? 'gap-2' : 'gap-4'} sm:gap-2 justify-center items-center relative`}
      >
        <button
          className={`text-left w-full
          sm:text-[40px] ${homeSection && "text-center max-w-[78%] sm:max-w-fit sm:font-medium text-[26px]"}
          ${toggle
