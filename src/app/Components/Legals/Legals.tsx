  ...
  return (
    <div className="w-full h-fit bg-blanc">
      <div className="w-full h-fit flex items-center justify-start pl-[10%] bg-blanc">
        <h1 className="py-4 font-semibold">MENTIONS LÉGALES</h1>
      </div>
      <div className="overflow-hidden bg-[url('/images/paris.jpeg')] bg-cover px-[10%] py-4 h-full flex gap-2">
        <div className="w-1/3 h-full space-y-2">
          ...
          <div className=" bg-rose-200/60 p-6 shadow-md">
            <div>
              <h1 className="text-[15px] sm:text-base text-[13px] sm:text-base border-1 border-b border-black pb-1 mt-3 font-semibold">
                II. Responsabilité
              </h1>
            </div>
            <div className="text-[11px] pt-2">
              ...
              utilisateurs une accessibilité du Site à tout moment et pour
              fournir des informations fiables. En cas d&apos;erreur ou
              d&apos;anomalie rencontrée par l&apos;utilisateur, ce dernier peut
              adresser un courriel à l&apos;adresse suivante :
              cabinet@vmdl.ai.En aucun cas le cabinet VMDL ne pourra être tenu
              pour responsable des erreurs rencontrées ou de
              l&apos;inaccessibilité du présent Site internet.Les données
              présentes sur ce Site internet sont fournies à titre informatif.
              Elles sont susceptibles de subir des modifications.
            </div>
          </div>
        </div>
        <div className="w-1/3 h-full space-y-2">
          <div className=" bg-cyan-200/60 p-6 flex flex-col shadow-md">
            ...
            <div className="text-[11px] pt-2">
              ...
              l&apos;objet de deux déclarations auprès de la Commission
              Nationale de l&apos;Informatique et des Libertés (CNIL) sous le
              numéro 2106644.
            </div>
          </div>
          <div className=" bg-rose-200/60 p-6 shadow-md">
            ...
            <div className="text-[11px] pt-2">
              ...
              l&apos;esprit protégée par les articles L.111-1 et suivants du
              Code de la propriété intellectuelle.En conséquence, sauf
              autorisation préalable et expresse de son auteur, toute
              reproduction ou représentation, totale ou partielle, de ce site
              Internet, par quelque procédé et sur quelque support que ce soit,
              est illicite.
            </div>
          </div>
        </div>
        <div className="w-1/3 h-full space-y-2">
          <div className=" bg-cyan-200/60 p-6 shadow-md">
            ...
            <div className="text-[11px] pt-2">
              Le cabinet VMDL se réserve le droit de modifier et
              d&apos;actualiser les présentes mentions légales à tout moment et
              sans préavis.L&apos;utilisateur est donc invité à le consulter
              régulièrement.
            </div>
          </div>
          <div className=" bg-cyan-200/60 p-2 shadow-md">
            ...
            <div className="text-[11px] flex flex-col">
              ...
              <p className="flex flex-col py-2">
                ...
                ASSOCIÉS dès votre prise d&apos;attache, y compris pour le
                simple établissement d&apos;un devis ou lors de la prise de
