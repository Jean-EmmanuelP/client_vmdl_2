  ...
  return (
    ...
    >
      <motion.div
        ...
        className="z-10"
      >
        <div className="p-2 sm:p-10 absolute top-[50%] left-[50%] -translate-y-1/2 -translate-x-1/2 flex flex-col gap-2 justify-center items-center text-center sm:text-xl text-white tracking-wide rounded-md bg-gray-600 bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20 border border-gray-100/20 shadow-2xl font-light text-sm" dangerouslySetInnerHTML={{ __html: formattedContent }}>
        </div>
      </motion.div>

      <video ref={videoRef} className="w-full h-full object-cover bg-black">
        <source src="/videos/place_des_vosges.mp4" type="video/mp4" />
      </video>
    </motion.div>
  );
}
